...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<article class="${"prose px-2 lg:prose-xl container mx-auto"}"><div><div><div><strong>TERMS OF USE</strong></div>

			<div><strong>Last updated</strong><strong>December 29, 2022</strong></div></div>

		<div><div><strong>1. AGREEMENT TO TERMS</strong></div></div>
		...
		<div><div><strong>2. INTELLECTUAL PROPERTY RIGHTS</strong></div></div>
		...
		<div><div><strong>3. USER REPRESENTATIONS</strong></div></div>
		...
		<div><div>If you provide any information that is untrue, inaccurate, not current, or incomplete, we
			...
			<div><div><strong>6. CANCELLATION</strong></div></div>
			...
			<div><div>If you are unsatisfied with our services, please email us at __________.</div>
				<div><strong>7. PROHIBITED ACTIVITIES</strong></div></div>
			...
			<div><div>As a user of the Site, you agree not to:</div>
				<ul><li>Systematically retrieve data or other content from the Site to create or compile,
					...
					<li>Sell or otherwise transfer your profile.</li></ul></div></div>
	...
	<div><div><strong>10. SUBMISSIONS</strong></div></div>
	...
	<div><div><strong>12. TERM AND TERMINATION</strong></div></div>
	...
	<div><div><strong>13. MODIFICATIONS AND INTERRUPTIONS</strong></div></div>
	...
	<div><div><strong>14. GOVERNING LAW</strong></div>
	...
	<div><div><strong>15. DISPUTE RESOLUTION</strong></div></div>
