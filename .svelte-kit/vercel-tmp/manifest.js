	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/prediction/_server.ts.js'))
			},
			{
				id: "/api/train",
				pattern: /^\/api\/train\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/train/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/webhooks/payment/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/webhooks/_slug_/instance_data/_server.ts.js'))
			},
			{
				...
				params: [{"name":"slug","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/webhooks/_slug_/prediction_complete/_server.ts.js'))
			},
			{
				...
				params: [{"name":"slug","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/webhooks/_slug_/training_complete/_server.ts.js'))
			},
			{
				id: "/(app)/app",
				pattern: /^\/app\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(homepage)/checkout/_server.ts.js'))
			},
			{
