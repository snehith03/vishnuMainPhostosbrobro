...
export const prompts: Theme[] = [
	{
		...
		instance_classes: [],
		prompt:
			'realistic closeup portrait of @me as a young jedi , highly detailed, science fiction, looking into camera, centred uncropped, star wars concept art, intricate details, bright colors, golden hour, art by marko djurdjevic, greg rutkowski, wlop, fredperry, digital painting, rossdraws.'
	}
