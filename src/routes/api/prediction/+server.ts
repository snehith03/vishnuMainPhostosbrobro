...
const prompts = [
	...
	"closeup portrait of @me as a cyberpunk blade runner, dramatic pose, wearing japanese techwear, uncropped face, intricate complexity, concept art, by ismail inceoglu dragan bibin hans thoma greg rutkowski alexandros pyromallis nekro rene maritte illustrated",
];
